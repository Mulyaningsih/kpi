            ...
            <div class="info-box">
              <div class="profil" id="profil">
                <div class="logo text-center">
                  ...
                  <i><?php echo '<img src ="assets/img/lambang.jpg",' . base64_encode($tampil['logo']) . '" alt="Image" style="width: 150px; height:150px;" >'; ?></i>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +62 853-8577-4717<br>
    ...
    <div class="container d-lg-flex py-4">
      ...
      <div class="social-links text-center text-lg-right pt-3 pt-lg-0">
        ...
        <a href="https://wa.me/+6285385774717<?php echo $tampil3['wa'];?>?text=Saya%20tertarik%20mendaftarkan%20agen%20milik%20saya"" class="whatsapp"><i class="bx bxl-whatsapp"></i></a>
