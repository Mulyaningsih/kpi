...
$query = "INSERT INTO agen_galon (id, nama_kota, nama, alamat, whatsapp, bank, ac) VALUES ('', '$nama_kota', '$nama', '$alamat', '$whatsapp', '$bank', '$ac')";
...
if($insertData){
    ...
    header("Refresh:0 ,url=../../index.php?page=tambah_agen_galon");
}
