<?php 
include '../koneksi.php';
$query = mysqli_query($koneksi, 'SELECT * FROM agen_elpiji INNER JOIN kota ON agen_elpiji.id_kota = kota.id');
?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Agen Elpiji</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Edit Agen Elpiji</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    ...
    ?>
        <form action="./agen_elpiji/config/update.php" method="POST">
