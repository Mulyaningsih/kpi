...
$query = "UPDATE agen_elpiji SET nama_kota='$nama_kota', nama='$nama', alamat='$alamat', whatsapp='$whatsapp', bank='$bank', ac='$ac' WHERE id='$id'";
...
if($updateData){
    ...
    header("Refresh:0 ,url=../../index.php?page=edit_agen_elpiji&&id='$id'");
}
?>