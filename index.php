  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="contacus.php">Contact</a></li>
    ...
    <div class="container d-lg-flex py-4">
      ...
      <div class="social-links text-center text-lg-right pt-3 pt-lg-0">
        ...
        <a href="https://www.instagram.com/antargalonidn" class="instagram"><i class="bx bxl-instagram"></i></a>
